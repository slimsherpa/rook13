            ...
            <div className="max-w-md mx-auto px-4 py-5">
                ...
                <div className="flex flex-col items-center mb-8">
                    {user.photoURL ? (
                        ...
                        <div className="w-20 h-20 rounded-full bg-navy-950 border-4 border-white/20 flex items-center justify-center text-white font-orbitron text-3xl">
                ...
                {!s || s.gamesPlayed === 0 ? (
                    ...
                    <>
                        ...
                        {s.redealsWitnessed > 0 && (
                            <div className="mt-3">
                                {stat('Legendary Redeals Witnessed', s.redealsWitnessed, true)}
                            </div>
                        )}
                    </>
                )}
