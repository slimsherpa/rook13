...
/** The whole philosophy in one breath — Riley's words, no jargon. */
function FunNote() {
    return (
        <div className="rounded-xl border border-white/15 bg-navy-950/50 p-3.5 mb-4 text-xs text-white/70 leading-relaxed">
            <span className="font-orbitron font-bold text-yellow-300">Rook is about having fun!</span>{' '}
            But friendly competition is fun too. Rank up by playing more games
            against harder opponents — mini-games count 🎮, and beating the
            family&apos;s best counts most. Lean on the{' '}
            <span className="font-bold" style={{ color: '#ff2d95' }}>AI trainer</span> or{' '}
            <span className="font-bold" style={{ color: '#ff9100' }}>card counter</span>{' '}
            and you won&apos;t rank up as fast. Badges run 🥉 Bronze to ⚡ GrandMaster —
            tap anyone to see their climb.
        </div>
    );
}
                ...
                >
                    ...
                    <span className="min-w-0 flex-1">
                        ...
                        <span className="block text-white/50 text-[11px]">
                            <RankBadge rank={rank} />
                            {skill.provisional && <span className="text-white/40"> · 🐣 placements</span>}
                        </span>
                        {rank.locked && (
                    ...
                    <div className="mb-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-white/30 text-[10px] font-orbitron">
                                {PLACEMENT_GAMES} games to get ranked
                            </span>
                        </div>
